        ...
        <section className="container mx-auto px-4 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/signin">
              <Button
                size="lg"
                className="h-14 px-8 rounded-full text-base font-semibold shadow-lg cursor-pointer
            ...
            <Button
              size="lg"
              variant="outline"
              className="group h-14 px-8 rounded-full text-base cursor-pointer
              transition-all duration-300 ease-out
              hover:scale-[1.03] hover:bg-accent hover:shadow-md
              active:scale-[0.98]"
            >
              Watch Demo
            </Button>
